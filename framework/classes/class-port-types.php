   ...
   */
	...
	class Post_Types{
		...
		function __construct( $parts ){
			...
			register_activation_hook( 'wp-css-generator/wp-css-generator.php',  array(&$this, 'plugin_rewrite_flush') );			
			...
			foreach ($this->post_types as $key => $value) :
						...
						register_post_type( $value['id'],
							array(
								...
								'public' 			 => isset( $value['public'] ) 			  ? $value['public'] : false,
							    'publicly_queryable' => isset( $value['publicly_queryable'] ) ? $value['publicly_queryable'] : true, 
							    'show_ui' 			 => isset( $value['show_ui'] ) 			  ? $value['show_ui'] : false,  
							    'show_in_menu' 		 => isset( $value['show_in_menu'] ) 	  ? $value['show_in_menu'] : false, 
							    'query_var' 		 => isset( $value['query_var'] ) 		  ? $value['query_var'] : true,
							    'rewrite' 			 => isset( $value['rewrite'] ) 			  ? $value['rewrite'] : false, 
